...
bool Conectado, Sshield, Espera, Sredes, Completo, Falha, ConexPerdida, Desconectado, Erro;
        ...
        File configFile = SPIFFS.open(filename, "r");
          if (configFile){
            ...
            if (!error){
              ...
              Sshield = json["Sshield"];
              Espera = json["Espera"];
              Sredes = json["Sredes"];
              Completo = json["Completo"];
              Falha = json["Falha"];
              ConexPerdida = json["ConexPerdida"];
...
void saveConfigFile(String filename){
  if(filename=="/wifi_status.json"){
    ...
    json["Sshield"] = Sshield;
    json["Espera"] = Espera;
    json["Sredes"] = Sredes;
    json["Completo"] = Completo;
    json["Falha"] = Falha;
    json["ConexPerdida"] = ConexPerdida;
